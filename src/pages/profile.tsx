                ...
                <form className={"ml-6 mr-6 "} onSubmit={(e) => {
                    ...
                    <div className={"field"}>
                        ...
                        <div className={"control"}>
                            <input type={"text"} className={"input"} name="title" defaultValue={post.title}
                    ...
                    <div className={"field"}>
                        ...
                        <div className={"control"}>
                            <input type={"text"} className={"input"} name={"content"} defaultValue={post.content}
        ...
        <>
            ...
            <div className={"box ml-6 mr-6 mt-6 is-half-desktop"}>
                ...
                {!isLoading && <div>
                    ...
                    <h2 className={"subtitle"}>Welcome in, {userName}!</h2>
                    <span className={"image is-64x64 mb-6"}>
            ...
            <div>
                {newsPosts.map((post, index) => (
                    <div key={index} className={"box ml-6 mr-6 mt-6 is-half-desktop"}>
                        ...
                        <ReactMarkdown
                            remarkPlugins={[remarkGfm, remarkBreaks]}>{post.content.replace('  ', '\n')}</ReactMarkdown>
                        <p className={"mt-5"}> {post.postTime}</p>
                        <div className={" "}>
                            {isCurrentUser &&
                                <button className={"button is-danger mt-4"} data-atr={post.id} onClick={() => {
                                    deletePost(post.id)
                                }}>Delete post</button>}
